...
class Ego4d_av_gaze_forecast(torch.utils.data.Dataset):
    ...
    def _construct_loader(self):
        ...
        # print(self.mode)
        if self.mode == 'train':
            path_to_file = 'data/folds_output/train_ego4d_0.csv'
        elif self.mode == 'val' or self.mode == 'test':
            path_to_file = 'data/folds_output/test_ego4d_0.csv'
        else:
    ...
    def __getitem__(self, index):
        ...
        for i_try in range(self._num_retries):
            ...
            print(video_name, labels_global_index)
            print(len(self._labels))
            print(f"Length of self._labels[{video_name}] = {self._labels[video_name].shape[0]}")
